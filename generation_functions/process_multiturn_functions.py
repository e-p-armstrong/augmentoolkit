...
def check_conversation_for_text_from_examples(conv):
    ...
    if matches_found > 2:
        print(f"Found {matches_found} matches for strings from the few-shot examples. Validation failed!")
        return False
    return True
...
def call_all_processors(multiturn_conversation, qatuples):
    ...
    if result is None:
        ...
        print("Each question does not contain a part of the question from tuples. Validation failed!")
        return False
...
if __name__ == "__main__":
    ...
    print("Expected False")
    print(has_sequential_chars("longstring", "short", 5))  # Expected False (n is longer than string2)
    print("Expected False")
    print(has_sequential_chars("overlap", "laptopp", 3))   # Expected True (partial overlap)
    print("Expected True")

    # Test cases for extract_conversation
    print("\nTesting extract_conversation:")
    test_conversation1 = "Charname1: Hello\nCharname2: Hi\nCharname3: How are you?"
    print(extract_conversation(test_conversation1))        # Expected [('Charname1', 'Hello'), ('Charname2', 'Hi'), ('Charname3', 'How are you?')]
    print("Expected [('Charname1', 'Hello'), ('Charname2', 'Hi'), ('Charname3', 'How are you?')]")
    ...
    dialogues1 = [("Charname1", "Hello"), ("Charname2", "Hi how are you"), "Totally Fantastic and Amazing!"]
    qatuples1 = [("How are you?", "Fine")]
    print(compare_answers_with_qatuples(dialogues1, qatuples1, 2))  # Expected False
    print("Expected False")
    dialogues2 = [("Charname1", "Hello"), ("Charname2", "Hi how are you"), ("Charname1", "Mostly Fine I think, yeah")]
    print(compare_answers_with_qatuples(dialogues2, qatuples1, 2))  # Expected True
    print("Expected True")
    dialogues3 = []
    qatuples2 = []
    print(compare_answers_with_qatuples(dialogues3, qatuples2, 2))  # Expected True (both empty)
    ...
    dialogues4 = [("Charname1", "Hello"), ("Charname2", "How are you?"), ("Charname1", "Fine, thank you for asking!")]
    print(check_for_repeated_dialogue_answers(dialogues4, qatuples_repeated_answers, 2))  # Expected True (no repetition)
    print("Expected True (no repetition)")
    dialogues5 = [("Charname1", "Hello"), ("Charname2", "How are you?"), ("Charname1", "Fine, thank you for asking! It's nice today, after all, so I'm Fine, thank you for asking!")]
    print(check_for_repeated_dialogue_answers(dialogues5, qatuples_repeated_answers, 2))  # Expected False (repetition)
    ...
    print(check_conversation_length(conv1, qatuples1))  # Expected False (conversation too short)
