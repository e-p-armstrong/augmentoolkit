from aphrodite import EngineArgs, AphroditeEngine, SamplingParams, AsyncAphrodite, AsyncEngineArgs
import asyncio
import uuid
...
class EngineWrapper():
    ...
    def __init__(self,model,quantization):
        engine_args = AsyncEngineArgs(model=model, quantization=quantization,engine_use_ray=False,disable_log_requests=True,max_model_len=12000)
