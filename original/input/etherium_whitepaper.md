...
_This introductory paper was originally published in 2014 by Vitalik Buterin, the founder of [Ethereum](https://ethereum.org/en/what-is-ethereum/), before the project's launch in 2015. It's worth noting that Ethereum, like many community-driven, open-source software projects, has evolved since its initial inception._

_While several years old, we maintain this paper because it continues to serve as a useful reference and an accurate representation of Ethereum and its vision. To learn about the latest developments of Ethereum, and how changes to the protocol are made, we recommend [this guide](https://ethereum.org/en/learn/)._

[Researchers and academics seeking a historical or canonical version of the whitepaper \[from December 2014\] should use this PDF.](https://ethereum.org/content/whitepaper/whitepaper-pdf/Ethereum_Whitepaper_-_Buterin_2014.pdf)

## [](https://ethereum.org/en/whitepaper/#a-next-generation-smart-contract-and-decentralized-application-platform)A Next-Generation Smart Contract and Decentralized Application Platform
...
## [](https://ethereum.org/en/whitepaper/#introduction-to-bitcoin-and-existing-concepts)Introduction to Bitcoin and Existing Concepts

### [](https://ethereum.org/en/whitepaper/#history)History
...
### [](https://ethereum.org/en/whitepaper/#bitcoin-as-a-state-transition-system)Bitcoin As A State Transition System

[![Ethereum state transition](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-state-transition.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-state-transition.png)
...
The "state" in Bitcoin is the collection of all coins (technically, "unspent transaction outputs" or UTXO) that have been minted and not yet spent, with each UTXO having a denomination and an owner (defined by a 20-byte address which is essentially a cryptographic public key<sup><a class="chakra-link css-1f04442" data-inline-link="true" href="https://ethereum.org/en/whitepaper/#notes">fn1</a></sup>). A transaction contains one or more inputs, with each input containing a reference to an existing UTXO and a cryptographic signature produced by the private key associated with the owner's address, and one or more outputs, with each output containing a new UTXO to be added to the state.
...
### [](https://ethereum.org/en/whitepaper/#mining)Mining

[![Ethereum blocks](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-blocks.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-blocks.png)
...
2. Check that the timestamp of the block is greater than that of the previous block<sup><a class="chakra-link css-1f04442" data-inline-link="true" href="https://ethereum.org/en/whitepaper/#notes">fn2</a></sup> and less than 2 hours into the future
...
### [](https://ethereum.org/en/whitepaper/#merkle-trees)Merkle Trees

[![SPV in Bitcoin](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fspv-bitcoin.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/spv-bitcoin.png)
...
### [](https://ethereum.org/en/whitepaper/#alternative-blockchain-applications)Alternative Blockchain Applications
...
### [](https://ethereum.org/en/whitepaper/#scripting)Scripting
...
## [](https://ethereum.org/en/whitepaper/#ethereum)Ethereum
...
### [](https://ethereum.org/en/whitepaper/#ethereum-accounts)Ethereum Accounts
...
### [](https://ethereum.org/en/whitepaper/#messages-and-transactions)Messages and Transactions
...
### [](https://ethereum.org/en/whitepaper/#messages)Messages
...
### [](https://ethereum.org/en/whitepaper/#ethereum-state-transition-function)Ethereum State Transition Function

[![Ether state transition](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fether-state-transition.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ether-state-transition.png)
...
### [](https://ethereum.org/en/whitepaper/#code-execution)Code Execution
...
### [](https://ethereum.org/en/whitepaper/#blockchain-and-mining)Blockchain and Mining

[![Ethereum apply block diagram](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-apply-block-diagram.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-apply-block-diagram.png)
...
## [](https://ethereum.org/en/whitepaper/#applications)Applications
...
### [](https://ethereum.org/en/whitepaper/#token-systems)Token Systems
...
### [](https://ethereum.org/en/whitepaper/#financial-derivatives-and-stable-value-currencies)Financial derivatives and Stable-Value Currencies
...
### [](https://ethereum.org/en/whitepaper/#identity-and-reputation-systems)Identity and Reputation Systems
...
### [](https://ethereum.org/en/whitepaper/#decentralized-file-storage)Decentralized File Storage
...
### [](https://ethereum.org/en/whitepaper/#decentralized-autonomous-organizations)Decentralized Autonomous Organizations
...
### [](https://ethereum.org/en/whitepaper/#further-applications)Further Applications
...
## [](https://ethereum.org/en/whitepaper/#miscellanea-and-concerns)Miscellanea And Concerns

### [](https://ethereum.org/en/whitepaper/#modified-ghost-implementation)Modified GHOST Implementation
...
### [](https://ethereum.org/en/whitepaper/#fees)Fees
...
(1) provides a tendency for the miner to include fewer transactions, and (2) increases `NC`; hence, these two effects at least partially cancel each other out.<sup><a target="_blank" rel="noopener" class="chakra-link css-1f04442" data-inline-link="true" href="https://github.com/ethereum/wiki/issues/447#issuecomment-316972260">How?<span class="css-idkz9h">(opens in a new tab)</span><svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 15 15" focusable="false" class="chakra-icon css-1bbj57d" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 2C2.44772 2 2 2.44772 2 3V12C2 12.5523 2.44772 13 3 13H12C12.5523 13 13 12.5523 13 12V8.5C13 8.22386 12.7761 8 12.5 8C12.2239 8 12 8.22386 12 8.5V12H3V3L6.5 3C6.77614 3 7 2.77614 7 2.5C7 2.22386 6.77614 2 6.5 2H3ZM12.8536 2.14645C12.9015 2.19439 12.9377 2.24964 12.9621 2.30861C12.9861 2.36669 12.9996 2.4303 13 2.497L13 2.5V2.50049V5.5C13 5.77614 12.7761 6 12.5 6C12.2239 6 12 5.77614 12 5.5V3.70711L6.85355 8.85355C6.65829 9.04882 6.34171 9.04882 6.14645 8.85355C5.95118 8.65829 5.95118 8.34171 6.14645 8.14645L11.2929 3H9.5C9.22386 3 9 2.77614 9 2.5C9 2.22386 9.22386 2 9.5 2H12.4999H12.5C12.5678 2 12.6324 2.01349 12.6914 2.03794C12.7504 2.06234 12.8056 2.09851 12.8536 2.14645Z" fill="currentColor"></path></svg></a></sup> (3) and (4) are the major issue; to solve them we simply institute a floating cap: no block can have more operations than `BLK_LIMIT_FACTOR` times the long-term exponential moving average. Specifically:
...
### [](https://ethereum.org/en/whitepaper/#computation-and-turing-completeness)Computation And Turing-Completeness
...
### [](https://ethereum.org/en/whitepaper/#currency-and-issuance)Currency And Issuance
...
#### [](https://ethereum.org/en/whitepaper/#long-term-supply-growth-rate-(percent))Long-Term Supply Growth Rate (percent)

[![Ethereum inflation](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-inflation.png&w=1920&q=75)](https://ethereum.org/content/whitepaper/ethereum-inflation.png)
...
### [](https://ethereum.org/en/whitepaper/#mining-centralization)Mining Centralization
...
### [](https://ethereum.org/en/whitepaper/#scalability)Scalability
...
## [](https://ethereum.org/en/whitepaper/#conclusion)Conclusion
...
## [](https://ethereum.org/en/whitepaper/#notes-and-further-reading)Notes and Further Reading

### [](https://ethereum.org/en/whitepaper/#notes)Notes
...
3. Internally, 2 and "CHARLIE" are both numbers<sup><a class="chakra-link css-1f04442" data-inline-link="true" href="https://ethereum.org/en/whitepaper/#notes">fn3</a></sup>, with the latter being in big-endian base 256 representation. Numbers can be at least 0 and at most 2<sup>256</sup>\-1.

### [](https://ethereum.org/en/whitepaper/#further-reading)Further Reading
...
_For history of the whitepaper, see [this wiki(opens in a new tab)](https://github.com/ethereum/wiki/blob/old-before-deleting-all-files-go-to-wiki-wiki-instead/old-whitepaper-for-historical-reference.md)._

_Ethereum, like many community-driven, open-source software projects, has evolved since its initial inception. To learn about the latest developments of Ethereum, and how changes to the protocol are made, we recommend [this guide](https://ethereum.org/en/learn/)._